...
public class HomeFragment extends Fragment {
    ...
    public HomeFragment(String loginUserName) {
    ...
    public static HomeFragment newInstance(String loginUserName, String param2) {
        HomeFragment fragment = new HomeFragment(loginUserName);
    ...
    private void createRecyclerView() {
        ...
        recyclerView = getActivity().findViewById(R.id.all_post_recycler_view);
    ...
    private void getPostByUsername(String userName) {
        ...
        mDatabase.child(POST_TABLE).orderByChild(TIMESTAMP).addValueEventListener(new ValueEventListener() {
            @Override
